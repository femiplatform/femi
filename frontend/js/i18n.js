...
"page.pregnancy": "การตั้งครรภ์",
    ...
    "preg.profile.gravida": "ครรภ์ที่ (G)",
    "preg.profile.para": "คลอดแล้ว (P)",
    "preg.profile.notes": "หมายเหตุ",
    "preg.profile.eddAuto": "ระบบจะคำนวณ EDD จาก LMP โดยอัตโนมัติ (LMP + 280 วัน)",
    ...
    "preg.anc.placePh": "เช่น รพ.สต. / โรงพยาบาล",
...
"page.pregnancy": "Pregnancy",
    ...
    "preg.profile.gravida": "Gravida (G)",
    "preg.profile.para": "Para (P)",
    "preg.profile.notes": "Notes",
    "preg.profile.eddAuto": "EDD is computed from LMP (LMP + 280 days).",
    ...
    "preg.anc.placePh": "Clinic / Hospital",
    "preg.anc.note": "Note",
    ...
    "preg.kicks.validation.date": "Please provide date",
