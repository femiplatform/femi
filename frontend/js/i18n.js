...
const DICT = {
  th: {
    ...
    // Tools (Tools page)
    "tools.recommendedTitle": "เครื่องมือแนะนำ",
    "tools.byCategoryTitle": "เครื่องมือดูแลสุขภาพตามหมวดหมู่",
    "tools.byCategorySubtitle": "เลือกเครื่องมือจากหมวดหลักด้านล่าง",

    "tools.cat1Title": "การสร้างเสริมสุขภาพและป้องกันโรค",
    "tools.cat1_1Title": "1.1 สุขภาพองค์รวม",
    "tools.cat1_1_a": "เครื่องคำนวณอายุสุขภาพ: BMR/TDEE + อายุสุขภาพ",
    "tools.cat1_1_b": "ตารางวางแผนตรวจสุขภาพ: To-do รายปี",
    "tools.cat1_1_c": "Mood Tracker: Emoji + EPDS",

    "tools.cat1_2Title": "1.2 มะเร็งเต้านม",
    "tools.cat1_2_a": "ประเมินความเสี่ยงมะเร็งเต้านม",
    "tools.cat1_2_b": "เตือนตรวจเต้านมรายเดือน + บันทึกผล",
    "tools.cat1_2_c": "ท่าทางตรวจเต้านมด้วยตนเอง",

    "tools.cat1_3Title": "1.3 มะเร็งปากมดลูก",
    "tools.cat1_3_a": "ประเมินความเสี่ยงมะเร็งปากมดลูก",
    "tools.cat1_3_b": "เตือน Pap smear / HPV test + บันทึกผล",

    "tools.cat1_4Title": "1.4 วัยทอง",
    "tools.cat1_4_a": "แบบประเมินความพร้อมก่อนวัยทอง",
    "tools.cat1_4_b1": "แบบประเมินความรู้พื้นฐานเกี่ยวกับวัยทอง",
    "tools.cat1_4_b2": "แบบประเมินอาการปัจจุบัน",
    "tools.cat1_4_b3": "แบบประเมินความพร้อมด้านสุขภาพ",
    "tools.cat1_4_b4": "แบบประเมินความพร้อมด้านจิตใจและสังคม",
    "tools.cat1_4_c": "ระบบติดตามอาการวัยทอง",

    "tools.cat2Title": "การวางแผนครอบครัว",
    "tools.cat2_a": "เลือกวิธีคุมกำเนิดอัจฉริยะ (Decision Tree)",
    "tools.cat2_b": "ติดตามรอบเดือน (Period Tracker)",
    "tools.cat2_c": "ประเมินความเสี่ยง STI + แผนที่สถานพยาบาลใกล้เคียง",
    "tools.cat2_d": "ช่วยแก้ปัญหาลืมกินยาคุม (Interactive)",

    "tools.cat3Title": "การดูแลครรภ์",
    "tools.cat3_a": "แดชบอร์ดติดตามครรภ์",
    "tools.cat3_b": "บันทึกการนับลูกดิ้น",
    "tools.cat3_c": "คัดกรองความเสี่ยงครรภ์เป็นพิษ",

    "tools.cat4Title": "การสร้างแรงจูงใจและชุมชน",
    "tools.cat4_a": "ควิซความรู้สุขภาพรายวัน",
